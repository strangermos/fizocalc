...
import levelAssessment, {
	sampleAssessment,
} from '../../utils/levelAssessment.js'
...
export default function AppContent() {
	...
	function handelSelectGender(value) {
		...
		if (
			value === 'Мужской' &&
			ower.categorySelect === 1 &&
			!(
				ower.ageSelect === '50 - 54' ||
				ower.ageSelect === '55 - 59' ||
				ower.ageSelect === '60 и старше'
			)
		) {
			a = 4
		} else if (
			...
			(ower.ageSelect === '50 - 54' ||
				ower.ageSelect === '55 - 59' ||
				ower.ageSelect === '60 и старше') &&
			ower.categorySelect !== 'Курсанты 1 курса' &&
			ower.categorySelect !== 'Курсанты 2 курса' &&
			ower.categorySelect !== 'Курсанты 3 - 5 курсов'
		) {
			a = 2
		} else if (
			value === 'Мужской' &&
			(ower.categorySelect === 2 || ower.categorySelect === 3) &&
			!(
				ower.ageSelect === '50 - 54' ||
				ower.ageSelect === '55 - 59' ||
				ower.ageSelect === '60 и старше'
			...
			value === 'Женский' &&
			!(ower.ageSelect === '45 - 49' || ower.ageSelect === '50 и старше')
		) {
			a = 3
		} else if (
			value === 'Женский' &&
	...
	function handelSelectAge(value) {
		...
		if (
			...
			ower.categorySelect === 1 &&
			!(value === '50 - 54' || value === '55 - 59' || value === '60 и старше')
		) {
			a = 4
		} else if (
			ower.genderSelect === 'Мужской' &&
	...
	function handelSelectCategory(value) {
		...
		if (
			(ower.genderSelect === 'Мужской' &&
				...
				value !== 'Курсанты 1 курса' &&
				value &&
				value !== 'Курсанты 2 курса' &&
				value !== 'Курсанты 3 - 5 курсов') ||
			...
			(ower.genderSelect === 'Женский' &&
				!(
					ower.ageSelect === '45 - 49' ||
					(ower.ageSelect === '50 и старше' &&
						value !== 'Курсанты 1 курса' &&
						value !== 'Курсанты 2 курса' &&
						value !== 'Курсанты 3 - 5 курсов')
				)) ||
			...
			(ower.genderSelect === 'Женский' &&
				(value === 'Курсанты 2 курса' || value === 'Курсанты 3 - 5 курсов'))
		) {
			a = 3
		} else if (
			ower.genderSelect === 'Мужской' &&
	...
	useEffect(() => {
		const i = levelAssessment(
			ower.genderSelect,
			ower.categorySelect,
			ower.ageSelect,
			ower.colSelect,
			exercise.ballsOneExercise,
			exercise.ballsTwoExercise,
			exercise.ballsThreeExercise,
			exercise.ballsFourExercise,
			exercise.ballsFiveExercise
		)
				...
				<Row gutter={[10, 10]}>
					<Col span={widthProject.left}>
						...
						>
							<Row gutter={[10, 0]}>
								<Col span={12}>
									<Form.Item label='Пол' name='genderForm'>
										<Select
											style={{}}
											//open={select}
								...
								<Col span={12}>
									{/* Возраст */}
									<Form.Item label='Возраст' name='ageForm'>
										<Select
											style={{}}
											//open={select}
								...
								<Col span={12}>
									{/* Категория */}
									<Form.Item label='Категория' name='categoryForm'>
										<Select
											style={{}}
											//open={select}
								...
								<Col span={12}>
									...
									<Form.Item label='Вес' name='weightForm'>
										{ower.genderSelect === 'Женский' && (
											<Select onChange={handelSelectWeight}>
												<Select.Option value='до 60 кг.'>
													до 60 кг.
												</Select.Option>
												<Select.Option value='от 60 до 70 кг.'>
													от 60 до 70 кг.
												</Select.Option>
												<Select.Option value='от 70 кг.'>
													от 70 кг.
												</Select.Option>
											</Select>
										)}
										{ower.genderSelect === 'Мужской' && (
											<Select onChange={handelSelectWeight}>
												<Select.Option value='до 70 кг.'>
													до 70 кг.
												</Select.Option>
												<Select.Option value='от 70 до 80 кг.'>
													от 70 до 80 кг.
												</Select.Option>
												<Select.Option value='от 80 кг.'>
													от 80 кг.
												</Select.Option>
											</Select>
										)}
                      ...
                      <Select disabled>
						...
						>
							...
							<Row gutter={[10, 0]}>
								<Col span={24}>
									<Form.Item name='setOneSelect'>
										<Select
											style={{}}
											placeholder={
												typeOfExercise[0][0] +
												(typeOfExercise[0][1] !== undefined
													? ' / ' + typeOfExercise[0][1]
													: '') +
												(typeOfExercise[0][2] !== undefined
													? ' / ' + typeOfExercise[0][2]
													: '')
											}
											...
											options={balls
												.filter(
													v =>
														v.quality === typeOfExercise[0][0] ||
														v.quality === typeOfExercise[0][1] ||
														v.quality === typeOfExercise[0][2]
												)
												.filter(v => v.age === '' || v.age === ower.ageOldYoung)
												.filter(
													v => v.weight === '' || v.weight === ower.weightSelect
												)
												.map(gen => ({
													id: gen.id,
													value: gen.name,
								...
								<Col span={12}>
									...
									>
										<Input
											...
											placeholder={
												exercise.minOnePlaseholder &&
												'от ' +
													exercise.minOnePlaseholder +
													' до ' +
													exercise.maxOnePlaseholder
											}
								...
								<Col span={12}>
									<Form.Item name='ballsOneRez' status='error'>
										<Input
											disabled={true}
											status='error'
											style={{
							...
							{ower.colSelect >= 2 && (
								<Row gutter={[10, 0]}>
									<Col span={24}>
										<Form.Item name='setTwoSelect'>
											<Select
												style={{}}
												placeholder={
													typeOfExercise[1][0] +
													(typeOfExercise[1][1] !== undefined
														? ' / ' + typeOfExercise[1][1]
														: '') +
													(typeOfExercise[1][2] !== undefined
														? ' / ' + typeOfExercise[1][2]
														: '')
												}
												...
												options={balls
													.filter(
														v =>
															v.quality === typeOfExercise[1][0] ||
															v.quality === typeOfExercise[1][1] ||
															v.quality === typeOfExercise[1][2]
													)
													.filter(
														v => v.age === '' || v.age === ower.ageOldYoung
													)
													.filter(
														v =>
															v.weight === '' || v.weight === ower.weightSelect
													)
													.map(gen => ({
														id: gen.id,
														value: gen.name,
									...
									<Col span={12}>
										...
										>
											<Input
												...
												placeholder={
													exercise.minTwoPlaseholder &&
													'от ' +
														exercise.minTwoPlaseholder +
														' до ' +
														exercise.maxTwoPlaseholder
												}
							...
							{ower.colSelect >= 3 && (
								<Row gutter={[10, 0]}>
									<Col span={24}>
										<Form.Item name='setThreeSelect'>
											<Select
												style={{}}
												placeholder={
													typeOfExercise[2][0] +
													(typeOfExercise[2][1] !== undefined
														? ' / ' + typeOfExercise[2][1]
														: '') +
													(typeOfExercise[2][2] !== undefined
														? ' / ' + typeOfExercise[2][2]
														: '')
												}
												...
												options={balls
													.filter(
														v =>
															v.quality === typeOfExercise[2][0] ||
															v.quality === typeOfExercise[2][1] ||
															v.quality === typeOfExercise[2][2]
													)
													.filter(
														v => v.age === '' || v.age === ower.ageOldYoung
													)
									...
									<Col span={12}>
										...
										>
											<Input
												...
												placeholder={
													exercise.minThreePlaseholder &&
													'от ' +
														exercise.minThreePlaseholder +
														' до ' +
														exercise.maxThreePlaseholder
												}
							...
							{ower.colSelect >= 4 && (
								<Row gutter={[10, 0]}>
									<Col span={24}>
										<Form.Item name='setFourSelect'>
											<Select
												style={{}}
												placeholder={
													typeOfExercise[3][0] +
													(typeOfExercise[3][1] !== undefined
														? ' / ' + typeOfExercise[3][1]
														: '') +
													(typeOfExercise[3][2] !== undefined
														? ' / ' + typeOfExercise[3][2]
														: '')
												}
												...
												options={balls
													.filter(
														v =>
															v.quality === typeOfExercise[3][0] ||
															v.quality === typeOfExercise[3][1] ||
															v.quality === typeOfExercise[3][2]
													)
													.filter(
														v => v.age === '' || v.age === ower.ageOldYoung
													)
									...
									<Col span={12}>
										...
										>
											<Input
												...
												placeholder={
													exercise.minFourPlaseholder &&
													'от ' +
														exercise.minFourPlaseholder +
														' до ' +
														exercise.maxFourPlaseholder
												}
							...
							{ower.colSelect === 5 && (
								<Row gutter={[10, 0]}>
									<Col span={24}>
										<Form.Item name='setFiveSelect'>
											<Select
												style={{}}
												placeholder={
													typeOfExercise[4][0] +
													(typeOfExercise[4][1] !== undefined
														? ' / ' + typeOfExercise[4][1]
														: '') +
													(typeOfExercise[4][2] !== undefined
														? ' / ' + typeOfExercise[4][2]
														: '')
												}
												...
												options={balls
													.filter(
														v =>
															v.quality === typeOfExercise[4][0] ||
															v.quality === typeOfExercise[4][1] ||
															v.quality === typeOfExercise[4][2]
													)
													.filter(
														v => v.age === '' || v.age === ower.ageOldYoung
													)
									...
									<Col span={12}>
										...
										>
											<Input
												...
												placeholder={
													exercise.minFivePlaseholder &&
													'от ' +
														exercise.minFivePlaseholder +
														' до ' +
														exercise.maxFivePlaseholder
												}
								...
								<Row gutter={[10, 10]}>
									...
									>
										<Typography.Title
											...
											type={
												exercise.itog &&
												(exercise.itog[0].toString() === '2'
													? 'danger'
													: exercise.itog[0].toString() === '3'
													? 'warning'
													: exercise.itog[0].toString() === '4'
													? 'secondary'
													: 'success')
											} // danger / success
											level={5}
										>
											...
											{exercise.itog &&
												(exercise.itog[0].toString() === '2'
													...
													: exercise.itog[0].toString() === '4'
													? 'Хорошо'
													: exercise.itog[0].toString() === '5 (3У)'
													? 'Отлично (3 уровень)'
													: exercise.itog[0].toString() === '5 (2У)'
													? 'Отлично (2 уровень)'
													: exercise.itog[0].toString() === '5 (1У)'
													? 'Отлично (1 уровень)'
													: exercise.itog[0].toString() === '5 (ВУ)'
