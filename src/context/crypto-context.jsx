...
import { fakeFetchExemple, fetchAssets, genderAssets, ageAssets, categoryAssets } from '../api';
...
export function CryptoContextProvider({ children }) {
    ...
    return (
        <CryptoContext.Provider value={{loading, balls, assets, gender, ages, category }}>
            { children }
